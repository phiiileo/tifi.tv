...
<body>
    <main class="container py-md-0">
            ...
            <div class="popular_brands col-12 pl-0 pr-0 pt-3">
                ...
                <article class="my-2 d-flex flex-wrap">
                    <span><input type="checkbox" name="netflix" id="netflix" value="Netflix"><img
                            src="uploads/new_netflix.png" alt=""></span>
                    <span><input type="checkbox" name="hulu" id="hulu" value="hulu"><img src="uploads/new_hulu.png"
                            alt=""></span>
                    <span><input type="checkbox" name="hbo" id="hbo" value="HBO"><img src="uploads/new_hbo.png"
                            alt=""></span>
                    <span><input type="checkbox" name="amazon" id="amazon" value="amazon"><img src="uploads/new_amazon.png"
                            alt=""></span>
                    <span><input type="checkbox" name="showmax" id="showmax" value="showmax"><img
                            src="uploads/new_showmax.png" alt=""></span>
                </article>
            </div>
        </section>
        ...
        <section class="row3 text-center mx-0 row my-3">
            <div class="img_container col-md-2  text-md-left mx-auto my-0 py-5 py-md-4 ml-md-n3">
                <img src="uploads/power.png" alt="" class="rounded-circle" width="100px" height="100px">
            ...
            <div class="personalize_acct  text-md-left col-md-10 mx-0 px-0 ">
                <section class="row mx-0 px-0">
                    <div class="col-lg-2  px-0">
                        <section class="mx-auto my-0 pb-1 p_type">Personality type </section>
                        <article class="genre genre--p d-flex flex-row flex-wrap mx-auto ml-md-0 mt-2">
                            <div class="m-1"><a href="#" class="_active">INTP</a></div>
                            <div class="m-1"><a href="#">INFP</a></div>
                            <div class="m-1"><a href="#">ISTJ</a></div>
                            <div class="m-1"><a href="#">ISTP</a></div>
                            <div class="m-1"><a href="#">ISFJ</a></div>
                            <div class="m-1"><a href="#">ISFP</a></div>
                            <div class="m-1"><a href="#">INFJ</a></div>
                            <div class="m-1"><a href="#">INTJ</a></div>
                            <div class="m-1"><a href="#">ESFJ</a></div>
                            <div class="m-1"><a href="#">ENTP</a></div>
                            <div class="m-1"><a href="#">ENFJ</a></div>
                            <div class="m-1"><a href="#">ESFP</a></div>
                            <div class="m-1"><a href="#">ENFP</a></div>
                            <div class="m-1"><a href="#">ESTJ</a></div>
                            <div class="m-1"><a href="#">ENTJ</a></div>
                            <div class="m-1"><a href="#">ESTP</a></div>
                        </article>
                    </div>
                    <div class="col-lg-3 my-2 my-md-0 px-0">
                        ...
                        <article class="genre d-flex flex-row flex-wrap mx-auto ml-md-0 mt-2">
                            <div class="m-1"><a href="#" class="_active">Horror</a></div>
                    ...
                    <section class="m_likes col-lg-7  px-md-0 ml-md-0">
                        <section class="p_type">Sample movies & series you like</section>
        ...
        <section class="row4 px-2 px-md-0 mt-5">
            ...
            <div
                class="movie_list mx-0 px-md-0 d-flex flex-row flex-wrap justify-content-around justify-content-md-between">
                <article>
                    <span>
    ...
    <main class="container p-md-0">
        <section class="row4 px-2 px-md-4">
            ...
            <div
                class="movie_list mx-0 px-md-2 d-flex flex-row flex-wrap justify-content-around justify-content-md-between">
                <article>
                    <div><img src="uploads/img8.png" alt=""></div>
                    <div class="m_details">
                        <span>1</span>
