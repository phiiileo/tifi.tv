<header class="my-3 mb-5">
    <section class="container-fluid">
        ...
        <section class="tifi_logo">
            <a href="index.php">
                <h3>tifi<svg width="40" height="30" viewBox="0 0 50 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <section class="header_search px-5">
                <div class="row">
                    <span class="pl-3 col-md-5 col-lg-4">
                        <a href="index.php" class="px-3">HOME</a>
                        <a href="#" class=" ">WHAT'S NEW</a>
                    </span>

                    <form action="" class="header_search_form m-auto ml-md-0 mr-md-0 col-md-4 col-lg-6">
                        <input type="text" placeholder="Search Movie or TV show"><button
                            class="search_btn fa fa-search"></button>
                    </form>
                </div>
            </section>

        <section class="header_user my-3 my-md-1">
            <p class="login">
